...
class Paths:
    ...
    COMMON_DIR: Path = SRC_DIR / "common"
    DATABASE_DIR: Path = SRC_DIR / "database"
    DB_DIR: Path = SRC_DIR / "db"

    # Diretórios de frontend
    STYLES_DIR: Path = FRONTEND_DIR / "styles"
    VIEWS_DIR: Path = FRONTEND_DIR / "views"
    WORKERS_DIR: Path = FRONTEND_DIR / "workers"

    # Arquivos de estilos
    STYLES_FILE: Path = STYLES_DIR / "styles.py"
